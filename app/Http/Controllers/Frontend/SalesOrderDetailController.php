...
class SalesOrderDetailController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.salesOrderDetails.index', compact('salesOrderDetails'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.salesOrderDetails.create', compact('products', 'sales_orders'));
    }
    ...
    public function store(StoreSalesOrderDetailRequest $request)
    {
        ...
        return redirect()->route('frontend.sales-order-details.index');
    }
    ...
    public function edit(SalesOrderDetail $salesOrderDetail)
    {
        ...
        return view('frontend.salesOrderDetails.edit', compact('products', 'salesOrderDetail', 'sales_orders'));
    }
    ...
    public function show(SalesOrderDetail $salesOrderDetail)
    {
        ...
        return view('frontend.salesOrderDetails.show', compact('salesOrderDetail'));
    }
