...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sales-order-details.update", [$salesOrderDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('integer') ? 'is-invalid' : '' }}" type="number" name="integer" id="integer" value="{{ old('integer', $salesOrderDetail->integer) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="number" name="price" id="price" value="{{ old('price', $salesOrderDetail->price) }}" step="0.01" required>
                @if($errors->has('price'))
