    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('product_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/product-units*") ? "menu-open" : "" }} {{ request()->is("admin/product-brands*") ? "menu-open" : "" }} {{ request()->is("admin/product-categories*") ? "menu-open" : "" }} {{ request()->is("admin/product-attributes*") ? "menu-open" : "" }} {{ request()->is("admin/product-variations*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
